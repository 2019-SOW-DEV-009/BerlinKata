...
public class FiveHourTest {
    ...
    @Test
    public void shouldReturnFalseWhenTwoFiveHoursAreNotEqual() throws InvalidDigitalHourException {
        assertNotEquals(createFiveHourWith(20), createFiveHourWith(23));
    }
